...
public class SwerveModuleSim implements SwerveModuleIO {
    private DCMotorSim driveMotor = new DCMotorSim(DCMotor.getNEO(1), SwerveModuleConstants.DRIVING_MOTOR_REDUCTION,
            0.025);
    private DCMotorSim turnMotor = new DCMotorSim(DCMotor.getNeo550(1), SwerveModuleConstants.STEERING_MOTOR_REDUCTION,
            0.025);
    ...
    public void updateInputs(SwerveModuleIOInputs inputs) {
        driveMotor.update(1.0 / kMainLoopFrequency);
        turnMotor.update(1.0 / kMainLoopFrequency);
